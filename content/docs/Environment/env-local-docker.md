...
Instead, you can use cloud platforms such as [Azure](/env/env-azure-docker.html).
{{ < /hint > }}
...
+ [Install Docker In Linux](/environment/env-local-docker-linux.html)
+ [Install Docker In macOS](/environment/env-local-docker-macos.html)
+ [Install Docker In Microsoft Windows](/environment/env-local-docker-windows.html)

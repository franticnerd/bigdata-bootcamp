...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/bigdata-bootcamp/flexsearch.min.js');loadScript('/bigdata-bootcamp/en.search-data.min.59ff21d6d51e7c4909235a8871202864c7748fb03d001d0897fa467fcd1c60cb.js',function(){input.required=false;search();});}

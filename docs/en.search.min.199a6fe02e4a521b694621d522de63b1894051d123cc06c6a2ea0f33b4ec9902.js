...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/bigdata-bootcamp/flexsearch.min.js');loadScript('/bigdata-bootcamp/en.search-data.min.73421a544634910cb0ec606b5a57048701a1481a4b7499de6007fc17a3a18b46.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/bigdata-bootcamp/flexsearch.min.js');loadScript('/bigdata-bootcamp/en.search-data.min.6410667277dcdb8b52f72bbd5f848dbdb90feb0187a1e6d2389f414cdb09f30e.js',function(){input.required=false;search();});}
